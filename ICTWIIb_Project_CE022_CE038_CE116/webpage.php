...
<head>
    ...
    <link rel="stylesheet" href="web_page1.css">
    <!-- CSS menu button -->
    ...
    <div class="navigation">
        <div class="navbar">
            ...
            <div id="myLinks">
                ...
                <a href="feedback.php" style="font-size:20px;"><i class="fa fa-comment" aria-hidden="true"></i></a>
                <a href="my_account.php" style="font-size:20px;"><i class="fa fa-sign-out" aria-hidden="true"></i></a>
                <a href="cart_show.php" style="font-size:20px;"><i class="fa fa-shopping-cart" aria-hidden="true"></i></a>
